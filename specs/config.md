...
Supported keys are `model`, `openai_api_key`, `anthropic_api_key`,
...
`/medium`, `/slow` and the Cocoa Model menu. A `[mounts]` table maps short relative paths to existing user
